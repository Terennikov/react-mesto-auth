...
const PopupWithForm = props => {
  ...
  return (
    <div onMouseDown={ handleOverlayClick } className={ `popup popup_type_${ props.name } ${ props.isOpen ? "popup_opened" : "" }` }>

      <div className={ `popup__container popup__container_type_${ props.name }` }>
        <button type="button" className="popup__close" onClick={ props.onClose }/>
        {props.icon && (
					<img className='popup__image-infoTooltip' src={props.icon} alt='props.title'></img>)}
